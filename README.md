...
## Environments
- Preview: https://main--pnamadobe-rlcorp--aemysites.aem.page/
- Live: https://main--pnamadobe-rlcorp--aemysites.aem.live/
- Block Library: https://main--pnamadobe-rlcorp--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `pnamadobe-rlcorp` directory in your favorite IDE and start coding :)
